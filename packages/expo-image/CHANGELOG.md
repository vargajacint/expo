...
- Add `onPlaceholderDisplay` event, emitted when a placeholder image is rendered. ([#XXXXX](https://github.com/expo/expo/pull/XXXXX) by [@vargajacint](https://github.com/vargajacint))
